...
PROJECT_ID = os.environ.get('GCP_PROJECT_ID', 'de8-devanis')
BUCKET = os.environ.get('GCP_GCS_BUCKET', 'pc2_dag_dwi')
...
BIGQUERY_DATASET = os.environ.get('BIGQUERY_DATASET', 'pc2_dataset_devanis')
...
with DAG(
    dag_id="pc2_dag_devanis",
    schedule_interval="@daily",
    default_args=default_args,
    catchup=False,
    max_active_runs=1,
    tags=['pc2_dataset_devanis'],
) as dag:
    ...
    local_to_gcs_task = PythonOperator(
        ...
        op_kwargs={
            "bucket": BUCKET,
            "object_name": f"data_raw_devanis/{parquet_file}",
    ...
    bigquery_external_table_task = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            ...
            "externalDataConfiguration": {
                ...
                "sourceUris": [f"gs://{BUCKET}/data_raw_devanis/{parquet_file}"],
            },
        },
    )
